...
write_preprocessed_data <- function() {
  models = c("transformer_1", "transformer_2", "transformer_3", "transformer_4", "transformer_5", "transformer_6", "transformer_8", "transformer_10",  "transformer_13", "lot", "lot_nonrecursive", "linear_or_prev", "gp", "comp_gp", "ridge", "linear")
  ...
  for (i in seq_along(models)) {
    ...
    for (j in seq_along(participants)) {
      ...
      df_participant_model <- get_df_participant_model(df_participant, df_model) %>% filter(!is.na(model_pred_x))
