    ...
    'use strict';
      ...
      class DotTaskExample1Plugin {
          ...
          trial(display_element, trial) {
              ...
              var success_audio2 = new Audio()
              success_audio2.src = 'static/sounds/frog_sound.mp3'
              var success_audio3 = new Audio()
              success_audio3.src = 'static/sounds/frog_sound.mp3'
              ...
              bg_image.src = 'static/pond.png'
              pad_image.src = 'static/pad.png'
              frog_image.src = 'static/frog.png'
              splash_image.src = 'static/ripple.png'
              ...
              function init_html() {
                  ...
                  html +=
                  '<br><button id="jspsych-canvas-game-ok" class="jspsych-btn"' +
                  ">" +
                  ">>" +
                  "</button>";
