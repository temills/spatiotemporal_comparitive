var jsPsychGreatJob = (function (jspsych) {
    ...
    class GreatJobPlugin {
        ...
        `);
            ...
            //trial.autoplay = false

            // setup stimulus
            var video_html = "<div>";
            video_html += '<video id="jspsych-video-button-response-stimulus" playsinline';
            if (trial.width) {
            ...
            if (trial.autoplay && trial.start == null) {
                ...
                video_html += " autoplay " + 'preload="auto"';
            }
            if (trial.controls) {
                video_html += " controls ";
            }
            ...
            // video_html += '<div><img src="' + file_name + '" style="width:700px;"></div>'
            video_html += "</div>";
          ...
          video_html += '</div>'
            ...
            video_html += "</div>";
            var audio = new Audio()
            audio.src = trial.audio_stimulus
