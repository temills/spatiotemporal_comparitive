...
seq_dict = JSON.parsefile("stimuli_all.json")["funcs"]
...
# SMC Experiment
trace_dict, score_dict = run_smc(xs, ys, n_particles, n_iter, seq_id=seq_name, out_dir=out_dir, move_from_true=true, visualize=false, record_preds=true)
