...
write_preprocessed_data <- function() {
  ...
  models = c("lin_prev")#"transformer_1", "transformer_4", "transformer_5", "transformer_6", "transformer_8", "transformer_10")#"transformer_2", "transformer_3", "transformer_13", "lot", "lot_no_recursion", "lin_prev", "gpnc", "gpsl", "ridge", "lin")
...
df_all$model = factor(df_all$model, levels = c("LoT",  "Comp. GP", "GP", "Ridge", "Linear + Prev.", "Linear"))#, "Nonrecursive LoT"))# "Transformer (2)", "Transformer (3)", "Transformer (13)")) 
