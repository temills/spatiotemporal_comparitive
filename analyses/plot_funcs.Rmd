...
plot_curve <- function(alpha_monkey, alpha_young, alpha_old, alpha_adult) {
  df_adult_filtered <-df_adult_filtered %>% mutate(alpha_val = 0)
  p <- ggplot() +
    ...
    stat_summary(data=df_adult_filtered, aes(x=n, y=correct, color="Adults"),
               fun.data="mean_se", geom="errorbar", alpha=alpha_adult, size=0.75, width=0.05) +
    stat_summary(data=df_adult_filtered, aes(x=n, y=correct, color="Adults"),
               fun="mean", geom="line", alpha=alpha_adult*0.6, size=0.6) +
    stat_summary(data=df_adult_filtered, aes(x=n, y=correct, color="Adults"),
               fun="mean", alpha=alpha_adult, geom="point") +
    stat_summary(data=df_adult_filtered, aes(x=n, y=correct),
               fun="mean", geom="point", alpha=alpha_adult, color="white", size=0.4) +
    stat_summary(data=df_kid_3_filtered, aes(x=n, y=correct, color="Children (3 yo)"),
                fun.data="mean_se", geom="errorbar", alpha=alpha_young, size=0.75, width=0.05) +
    stat_summary(data=df_kid_3_filtered, aes(x=n, y=correct, color="Children (3 yo)"),
                fun="mean", geom="line",alpha=alpha_young*0.6, size=0.6) +
    stat_summary(data=df_kid_3_filtered, aes(x=n, y=correct, color="Children (3 yo)"),
                fun="mean", alpha=alpha_young, geom="point") +
    stat_summary(data=df_kid_3_filtered, aes(x=n, y=correct),
                fun="mean", geom="point", alpha=alpha_young, color="white", size=0.4) +
    stat_summary(data=df_kid_47_filtered, aes(x=n, y=correct, color="Children (4-7 yo)"),
                fun.data="mean_se", geom="errorbar", alpha=alpha_old, size=0.75, width=0.05) +
    stat_summary(data=df_kid_47_filtered, aes(x=n, y=correct, color="Children (4-7 yo)"),
                fun="mean", geom="line", alpha=alpha_old*0.6, size=0.6) +
    stat_summary(data=df_kid_47_filtered, aes(x=n, y=correct, color="Children (4-7 yo)"),
                fun="mean", alpha=alpha_old, geom="point") +
    stat_summary(data=df_kid_47_filtered, aes(x=n, y=correct),
                fun="mean", geom="point", alpha=alpha_old, color="white", size=0.4) +
    stat_summary(data=df_monkey_test_filtered, aes(x=n, y=correct, color="Monkeys"),
                fun.data="mean_se", geom="errorbar", alpha=alpha_monkey, size=0.75, width=0.05) +
    stat_summary(data=df_monkey_test_filtered, aes(x=n, y=correct, color="Monkeys"),
                fun="mean", geom="line", alpha=alpha_monkey*0.6, size=0.6) +
    stat_summary(data=df_monkey_test_filtered, aes(x=n, y=correct, color="Monkeys"),
                fun="mean", alpha=alpha_monkey, geom="point") +
...
ggsave(paste0("../slide_figs/", "curves_", 1, ".png"), plot_curve(0,0,0,0), width=12.5, height=4.5)
ggsave(paste0("../slide_figs/", "curves_", 2, ".png"), plot_curve(1,0,0,0), width=12.5, height=4.5)
ggsave(paste0("../slide_figs/", "curves_", 3, ".png"), plot_curve(1,1,0,0), width=12.5, height=4.5)
ggsave(paste0("../slide_figs/", "curves_", 4, ".png"), plot_curve(1,1,1,0), width=12.5, height=4.5)
ggsave(paste0("../slide_figs/", "curves_", 5, ".png"), plot_curve(1,1,1,1), width=12.5, height=4.5)
```
