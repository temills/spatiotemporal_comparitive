...
df_all <- df_mean_kid_chs %>% filter(!(func.type %in% c('radial_increasing'))) %>% filter(exact_age<8)
...
plot_scatter <- function(dfx, dfy, name_x, name_y) {
  ...
  plot_df <- plot_df %>%
              mutate(image_path = sprintf("/Users/traceymills/Dropbox (MIT)/cocosci_projects/dots/spatiotemporal_comparitive/analyses/figs/func_ims/%s.png", func.type))
